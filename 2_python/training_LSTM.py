...
def main():
    ...
    hyperparams_csv    = "../2_trained_models/LSTM/trained_models/ref/it_6_norm/hyperparams_LSTM_it_6.csv"

    # Output locations (prefixes)
    location_state = "../2_trained_models/LSTM/trained_models/ref/it_6_norm/state_models/lon/model_LSTM_lon_"
    location_onnx  = "../2_trained_models/LSTM/trained_models/ref/it_6_norm/traced_models/lon/model_LSTM_lon_"
